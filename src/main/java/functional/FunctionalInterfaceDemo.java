...
public class FunctionalInterfaceDemo {
    public static void main(String[] args) {
        //DEFINIUJEMY PREDYKAT, per jest tylko paramtetrem metody
        Predicate<Person> isPointGreaterThan10 = per -> per.getPoint() > 10;
        ...
        filter = p -> person.getName().contains("A");
        if (filter.test(person)){
            System.out.println("OK");
        }
        ...
        /**
         *  Person get(){
         *      return new Person("ADA,2);
         *  }
         */
        Supplier<Person> createPerson = () -> new Person("ADA", 2);
        createPerson.get();
        //CONSUMER
        /**
